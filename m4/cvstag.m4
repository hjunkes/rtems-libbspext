#
# TILLAC_CVSTAG([$Name: R_libbspExt_1_6 $], [pattern])
#
# Strip $Name: R_libbspExt_1_6 $ from first argument extracting
...
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: R_libbspExt_1_6 $]))
#
...
# and using the macro:
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: R_libbspExt_1_6 $],'Release_'))
#
